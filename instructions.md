...
- In March, the three major indexes of the New York Stock Exchange hit an all-time high as the Federal Openings Committee (FOMC) announced that it would cut interest rates three times this year. As inflation exceeded expectations at the beginning of the year, market concerns that the Federal Reserve (Fed) could reduce the number of rate cuts to two within this year have subsided.
On the New York Stock Exchange (NYSE) on the 20th (local time), the Dow Jones Industrial Average rose 401.37 points (+1.03%) to close at 39,512.13. The S&P 500 rose 46.11 points (+0.89 percent) to close at 5,224.62, while the tech-heavy Nasdaq Composite jumped 202.62 points (+1.25 percent) to close at 16,369.41.
After the FOMC in March, the New York stock market rose as soon as the dot plot was released. The Fed maintained the benchmark interest rate at 5.25 to 5.5 percent and suggested 4.5 to 4.75 percent at the end of this year. This is the same as its forecast in December. If the Fed cuts 25 basis points each, it is expected to cut it three times this year. In response, the market shook off concerns that the Fed could offer fewer than two rate cuts within this year at the upcoming FOMC.
"Although inflation indicators for January and February were high, the overall narrative (that inflation continues to slow) has not changed," Chairman Jerome Powell said at a FOMC news conference.
He also announced that he would soon slow down quantitative tightening. "We had discussions about slowing down the pace of decline in our holdings," Powell said. "We have not made any decision yet, but we have reached a consensus that it is better to slow down fairly soon."
As Chairman Powell gave off a dovish color at the FOMC, the market's interest rate cut in June also resurfaced. According to the Chicago Mercantile Exchange (CME), the probability of a rate cut in June rose more than 15 percentage points from 59.1% the previous day to 74.4% after the press conference.
As a result, the yield on U.S. government bonds fell. The 2-year interest rate, which is sensitive to the outlook for changes in the benchmark interest rate, fell 8.8 basis points (1 basis point=0.01 percentage point) to 4.604 percent on the day. The 10-year yield fell 2.5 basis points to 4.271 percent. The interest rate on government bonds moves in the opposite direction to prices.
Financial stocks rose on expectations of a rate cut. American Express rose 2.8%, while JPMorgan rose 1.31%. The SPDR S&P Regional Bank ETF rose more than 3%. Technology stocks also rose. Alphabet rose 1.16% and Meta rose 1.87%.
Intel shares rose 0.36 percent. Intel rose 0.36 percent on reports that it would provide $8.5 billion in subsidies for the Chipmunks Act and $11 billion in loans in total. Chipotle gained 3.48 percent on news of the stock split. Chipotle plans to split its current stock 50-1 as of June. The split would not affect a company's fundamentals, but would lower prices per share around $3,000, which would improve investor psychological access, Wall Street said.
Asterlabs, the first AI and cloud infrastructure builder to be traded on the Nasdaq, surged 72.31 percent. The IPO price of Asterlabs started at 36 dollars and closed at 62 dollars. Nvidia rose 1.09 percent. Boeing, which has recently been struggling with a glitch in its 737 Max model, closed up 3.67 percent on the day. Bloomberg and other foreign media reported that Boeing will sell at least two defense units.
Major virtual assets have also been on the rise since FOMC. Bitcoin is trading at $67,094 dollars, up 3.73% from 24 hours ago. Ether is up 4% at $3472. Shares of Coinbase are up 11.63%, hit by a strong coin price.
Oil prices in New York fell. In April, the price of West Texas Intermediate (WTI) crude oil in India closed at 81.68 dollars per barrel on the New York Mercantile Exchange, down 1.79 dollars, or 2.14 percent, from the previous day.
