...
UPBIT_ACCSESS = "r9TcZo1xRoGzeQqI2mAw9LOhhmyKdVaVUB5o1jfb"
UPBIT_SECRET = "G7z8zJkxsbCCT8PuTmxdUFYI7pybNnG3POc747Nq"

client = OpenAI(api_key=os.getenv('OPENAI_API_KEY'))
upbit = pyupbit.Upbit(UPBIT_ACCSESS, UPBIT_SECRET)
...
if __name__ == "__main__":
    ...
    schedule.every(6).hours.at("00:01").do(make_decision_and_execute)
